...
This procedure covers Attach, Fresh setup, and Observe validation. Assist is a separate controlled
release track; see [Transaction engine and Assist](../product/transaction-engine-v1.md).
