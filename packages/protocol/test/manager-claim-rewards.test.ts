...
describe("reference-manager claim-rewards transaction planner", () => {
  it("emits the reviewed deterministic testnet vector", async () => {
    ...
    expect(plan).toMatchObject({
      ...
      intentHash: "452d8604d41eb791d5f704a14bde59c948f529196d2897ad8919da80c2bddedf",
      unsignedTransactionSha256: "87b69ec6b1ce0d63ecba1731f668935b4db79bbca38698c342948a83fb746ead",
      material: {
        adapter: {
        ...
        transaction: {
          ...
          unsignedTransactionSha256:
            "87b69ec6b1ce0d63ecba1731f668935b4db79bbca38698c342948a83fb746ead",
        },
      },
    });
    expect(plan.unsignedTransactionHex).toBe(
      "",
    );
  });
